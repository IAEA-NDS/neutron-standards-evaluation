...
# add 0.85% uncertainty to the absolute Fission TPC measurement (exp_6002)
exp_6002_sel = exptable.NODE == 'exp_6002'
expcov = expcov.toarray()
expcov[np.ix_(exp_6002_sel, exp_6002_sel)] += 0.0085**2
