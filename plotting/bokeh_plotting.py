...
dfs = prepare_result_data('8d55148')
...
# cols.append("PRED")
pred_list.append(load_evaluation('8d55148', 're-eval STD2017 + USU (MLE)', 'green', 'solid'))
cols.append("MAXLIKE")
pred_list.append(load_evaluation('8d55148', 're-eval STD2017 + USU (MCMC)', 'brown', 'dotdash'))
cols.append("PRED")
