...
dfs = prepare_result_data('5a7a76e')
...
pred_list = []
cols = []
pred_list.append(load_evaluation('5a7a76e', 'Latest + Correct Lisowski covmat (MAXLIKE)', 'green', 'solid'))
cols.append("MAXLIKE")
pred_list.append(load_evaluation('5a7a76e', 'Latest + Correct Lisowski covmat (MCMC)', 'brown', 'dotdash'))
cols.append("PRED")
pred_list.append(load_evaluation('f96d2f3', 'Latest (MAXLIKE)', 'blue', 'dotdash'))
cols.append("MAXLIKE")
pred_list.append(load_evaluation('f96d2f3', 'Latest (MCMC)', 'black', 'solid'))
cols.append("PRED")
