...
cols.append("MAXLIKE")
pred_list.append(load_evaluation('89dc6bf', 'drop TPC (6001) MCMC', 'red', 'solid'))
cols.append("PRED")
pred_list.append(load_evaluation('89dc6bf', 'drop TPC (6001) OPT', 'blue', 'dotdash'))
cols.append("MAXLIKE")
pred_list.append(load_evaluation('ea40e40', 'latest eval', 'black', 'solid'))
cols.append("PRED")
pred_list.append(load_evaluation('04cc6d2', 'drop Sherbakov (1012) MCMC', 'cyan', 'dashed'))
cols.append("PRED")
pred_list.append(load_evaluation('04cc6d2', 'drop Sherbakov exp (1012) OPT', 'brown', 'dotdash'))
cols.append("MAXLIKE")
