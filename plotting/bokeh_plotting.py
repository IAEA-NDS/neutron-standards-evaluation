...
dfs = prepare_result_data('7db8ebb')
...
# cols.append("PRED")
pred_list.append(load_evaluation('7db8ebb', 'NewInp+SACS+Recom23+USU (MLE)', 'green', 'solid'))
cols.append("MAXLIKE")
pred_list.append(load_evaluation('7db8ebb', 'NewInp+SACS+Recom23+USU (MCMC)', 'brown', 'dotdash'))
cols.append("PRED")
pred_list.append(load_evaluation('4610454', 'NewInp+SACS+Recom23+USU+NIFFTE24 (MLE)', 'blue', 'dotdash'))
cols.append("MAXLIKE")
pred_list.append(load_evaluation('4610454', 'NewInp+SACS+Recom23+USU+NIFFTE24 (MCMC)', 'black', 'solid'))
cols.append("PRED")
