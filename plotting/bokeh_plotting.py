...
dfs = prepare_result_data('f96d2f3')
...
pred_list = []
cols = []
pred_list.append(load_evaluation('f96d2f3', 'NewInp+SACS+Recomm23+NIFFTE24 (MLE)', 'green', 'solid'))
cols.append("MAXLIKE")
pred_list.append(load_evaluation('f96d2f3', 'NewInp+SACS+Recomm23+NIFFTE24 (MCMC)', 'brown', 'dotdash'))
cols.append("PRED")
pred_list.append(load_evaluation('4610454', 'NewInp+SACS+Recomm23+NIFFTE24+USU (MLE)', 'blue', 'dotdash'))
cols.append("MAXLIKE")
pred_list.append(load_evaluation('4610454', 'NewInp+SACS+Recomm23+NIFFTE24+USU (MCMC)', 'black', 'solid'))
cols.append("PRED")
